...
\newglossaryentry{OracleUCM}{name={Oracle UCM}, description={Oracle Universal-Content-Management},text={Oracle UCM}}
...
\newglossaryentry{SSL}{name={SSL}, description={Secure Sockets Layer},text={SSL}}
\newglossaryentry{UDDI}{name={UDDI}, description={Universal Description, Discovery and Integration protocol},text={UDDI}}
\newglossaryentry{IIS}{name={IIS}, description={Internet Information Service},text={IIS}}
\newglossaryentry{PHP}{name={PHP}, description={PHP: Hypertext Preprocessor},text={PHP}}
%%%%%
%
% glossary entries
%
