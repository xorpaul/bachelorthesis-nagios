...
Dienste, die im Netzwerk zur Verfügung stehen (Netzwerkdienste), wie ein Web- oder FTP-Server glossary{name={FTP}, description={File Transfer Protocol}}, lassen sich einfach / simpel direkt über das Netz auf ihren Zustand (hin) überprüfen /  testen.
