...
\begin{figure}[ht]
	\centering
	   \fbox{\includegraphics[width=0.75\textwidth]{bilder/nsc1.png}}
...
\begin{figure}[ht]
	\centering
	   \fbox{\includegraphics[width=0.7\textwidth]{bilder/nsc2.png}}
...
\begin{figure}[ht]
	\centering
	   \fbox{\includegraphics[width=0.85\textwidth]{bilder/nagios-active-nsclient-and-nrpe.png}}
...
Um dies zu verhindern wurde der Port beim NSClient++ bereits auf einen höheren Port (12489) gewechselt.

Diesen Standardport der Anwendung wird zusätzlich noch verändert, damit die Tatsache, dass sich ein Nagios-Agent auf dem Computer befindet, nicht sofort ersichtlich ist.
...
;# SSL SOCKET
;#  Die Aktivierung der Verschlüsselung der Kommunikation zwischen Nagios- und Windows-Server durch SSL
use_ssl=1

;# NRPE BEFEHLS DEFINITIONEN
;# Befehlsdefinition, die durch den NRPE-Dienst aufrufbar sind
