...
\begin{figure}[ht]
	\centering
	   \fbox{\includegraphics[width=0.85\textwidth]{bilder/cci4.png}}
...
\begin{figure}[ht]
	\centering
	   \fbox{\includegraphics[width=0.57\textwidth]{bilder/3aufgaben.png}}
...
\begin{figure}[ht]
	\centering
	   \fbox{\includegraphics[scale=0.9]{bilder/cmsdms3.png}}
...
Wie zuvor beschrieben ist die Sichtweise eines \gls{DMS} nur auf die einzelnen Dokumente beschränkt, während ein \gls{CMS} einzelne Informationsbausteine aus den Dokumenten extrahieren und ggf. zu einem neuen Dokument verschmelzen kann. Die Sichtweise des \gls{CMS} wird durch das gestrichelte Polygon dargestellt, welches hier dokumentenübergreifend abgebildet ist.

Der tiefere Sinn eines \gls{CMS}-Systems ist laut Oracle folgendermaßen definiert:
...
Ein \gls{CMS} soll die Informationen jedwedem Inhalts extrahieren und jedes Element dieser Information den Benutzern zugänglich machen, unabhängig von der Art des Zugriffs.
Dieses Konzept soll in Abbildung \ref{ucm-a2a} verdeutlicht werden.

\begin{figure}[ht]
	\centering
	   \fbox{\includegraphics[width=0.8\textwidth]{bilder/ucm.png}}
