...
\begin{figure}[ht]
	\centering
	   \fbox{\includegraphics[width=0.85\textwidth]{bilder/contentserverrc6.png}}
...
\paragraph{Services}
\begin{itemize}
\item \textbf{IdcContentService}  Den Zustand des Content Server-Dienstes \pictext{sccdms01} überprüfen.
\item \textbf{IdcAdminService}  Den Dienst für die Content Server-Administration \pictext{sccdms01\_admin} überwachen.
