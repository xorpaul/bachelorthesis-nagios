...
Dadurch müssen nurnoch die spezifischen Informationen und der Name des übergeordneten Host-Objektes eingetragen werden.
...
\begin{figure}[ht]
	\centering
	   \fbox{\includegraphics[width=0.9\textwidth]{bilder/example-ping.png}}
