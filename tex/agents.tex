...
Dabei wird die Auswahl der Kandidaten auf 4 Bewerber beschränkt, siehe Tabelle \ref{tab:winagents}.
...
\begin{figure}[ht]
	\centering
	   \fbox{\includegraphics[width=0.6\textwidth]{bilder/nsc2.png}}
