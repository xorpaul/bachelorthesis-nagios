...
\begin{figure}[ht]
	\centering
	  \fbox{\includegraphics[width=0.7\textwidth]{bilder/klartext.png}}
...
\begin{figure}[ht]
	\centering
	  \fbox{\includegraphics[width=0.75\textwidth]{bilder/ssl-text.png}}
...
\begin{figure}[ht]
	\centering
	  \fbox{\includegraphics[width=0.5\textwidth]{bilder/cpu-load2.png}}
