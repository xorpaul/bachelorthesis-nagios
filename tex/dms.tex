...
Dabei wird ein DMS in drei verschiedene Teilbereiche aufgegliedert:

\subsubsection{Eingabe}



\subsubsection{Archivierung und Verwaltung}
...
Im Gegensatz zu anderen CMS-Systemen, wie Typo3 oder Joomla, bezeichnet Oracle seine Softwarelösung in diesem Bereich als Universal-Content-Management (\glsadd{UCM}).
