...
\begin{figure}[ht]
	\centering
	   \fbox{\includegraphics[width=0.8\textwidth]{bilder/ci-nci.png}}
...
\begin{figure}[ht]
	\centering
	   \fbox{\includegraphics[width=0.8\textwidth]{bilder/dms-circle.png}}
...
Hier wird die Zuspielung der Dokumente in das \gls{DMS}-System durch verschiedene Methoden behandelt / realisiert.
...
\begin{figure}[ht]
	\centering
	   \fbox{\includegraphics[scale=0.25]{bilder/cmsview.png}}
