...
\begin{figure}[ht]
	\centering
	   \fbox{\includegraphics[width=0.06\textwidth]{bilder/basic_architecture.png}}
...
\begin{tabular}{l l l}
%\hline
\textbf{Alter der Daten } \hspace{10 mm} & \textbf{Auflösung} \hspace{10 mm} & \textbf{Auswerten der Logs} \hspace{10 mm}\\
\hline
