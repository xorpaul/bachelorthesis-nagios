...
\begin{figure}[ht]
	\centering
	   \fbox{\includegraphics[width=0.85\textwidth]{bilder/wsdlscrn.png}}
...
\begin{figure}[ht]
	\centering
	   \fbox{\includegraphics[width=0.85\textwidth]{bilder/wsdl.png}}
...
Für die Überprüfung auf den gültigen Datentyp wird direkt in den Binärcode der verschiedenen Versionen des Testbildes geschaut.

\begin{figure}[ht]
	\centering
	   \fbox{\subfigure[PNG-Bild]{\includegraphics[scale=0.6]{bilder/eregi-png.png}} \quad \quad
	   \subfigure[JPEG-Bild]{\includegraphics[scale=0.6]{bilder/jpg-eregi.png}}
	   }
		\caption{Binärcode von PNG- und JPEG-Bilddateien}
		\label{bytecode}
\end{figure}
...
\begin{figure}[ht]
	\centering
	   \fbox{\includegraphics[width=0.85\textwidth]{bilder/wsdl-valid.png}}
...
\begin{figure}[ht]
	\centering
	   \fbox{\includegraphics[width=0.85\textwidth]{bilder/cwsdl2.png}}
