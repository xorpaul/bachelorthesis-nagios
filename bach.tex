...
\hypersetup{
    ...
    pdftitle={Entwicklung eines Nagios-Plugins zur Überwachung und Auswertung von Funktionen und Fehlern in Content-Managment-Systemen},    % title
    pdfauthor={Andreas Paul},     % author
    pdfsubject={Bachelorarbeit 2009 TIT06},   % subject of the document
    pdfcreator={Andreas Paul},   % creator of the document
    pdfproducer={Andreas Paul}, % producer of the document
    pdfkeywords={Nagios, OracleUCM}, % list of keywords
